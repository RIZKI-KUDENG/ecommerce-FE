           ...
           <form action="" className=" p-3">
            <FieldSet>
                ...
                <Field>
                    ...
                    <input type="text" placeholder="Name" className="border-b border-black w-full" />
                </Field>
                <Field>
            ...
            <div className="mt-5 flex flex-col gap-3 items-center w-full">
                <Button className="bg-red-400 hover:bg-red-600 w-full">Create Account</Button>
                <Button variant="outline" className="w-full">Sign up with Google</Button>
                <div className="flex justify-between w-full">
                    <h5 className="text-sm text-red-400">Already have an account?</h5>
                    <Link href='/login' className="text-sm text-red-400 hover:underline">Sign in</Link>
                </div>
            </div>
           </form>
        </div>
